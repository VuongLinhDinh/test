    ...
    <table border="1">
        ...
        <?php foreach($flights as $value): ?>
            <tr>
                ...
                <td>
                    <button><a href="edit.php?<?= $value['flight_id']?>">EDIT</a></button>
                    <button><a onclick="return confirm('Bạn muốn xóa nó đi chứ')" href="delete.php?<?= $value['flight_id']?>">DELETE</a></button>
                </td>
            </tr>
        <?php endforeach?>
    </table>
